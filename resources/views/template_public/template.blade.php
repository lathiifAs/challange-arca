  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>{{ $_portal_data->name }}</h3>
            <p>
                {{ $_portal_data->address }} <br><br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>{{ $_portal_data->name }}</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://dayutekno.com/">{{ $_portal_data->name }}</a>
        </div>
      </div>
