...
@section('konten')
    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <form action="{{ route('master.buruh.update') }}" method="POST" action="" enctype="multipart/form-data">
                <input type="hidden" value="{{ $buruh->id }}" name="id" id="">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" required
                                            name="nama" value="{{ $buruh->nama }}" placeholder="Nama">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="alamat" value="{{ $buruh->alamat }}" required
                                            placeholder="alamat">
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
