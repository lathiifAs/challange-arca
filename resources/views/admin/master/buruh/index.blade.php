                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.buruh') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.buruh.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                    ...
                    <div class="card-block table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse($buruh as $key=> $brh)
                                        <tr>
                                            <th class="text-center">{{ $key + 1 }}</th>
                                            <td>{{ $brh->nama }}</td>
                                            <td class="text-center">{{ $brh->alamat }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('master.buruh.edit', $brh->id) }}" title="edit"
                                                    class="btn waves-effect waves-light btn-out btn-warning rounded"><i
                                                        class="fa fa-edit"></i></a>
                                                @if (auth()->user()->type == 'admin')

                                                <a href="#" onclick="hapus({{ $brh->id }})" title="Hapus"
