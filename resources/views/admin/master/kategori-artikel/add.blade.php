...
@section('konten')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('master.kategori-artikel') }}">Master</a>
                        </li>
    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <form action="{{ route('master.kategori-artikel.add') }}" method="POST" action="" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('master.kategori-artikel') }}"
