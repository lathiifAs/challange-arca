                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.kategori-artikel') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.kategori-artikel.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                    ...
                    <div class="card-block table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse($data as $key=> $kategori_artikel)
                                        <tr>
                                            <th class="text-center">{{ $key + 1 }}</th>
                                            <td class="text-center">
                                                <img src="{{ URL($kategori_artikel->img_path.$kategori_artikel->img_name)}}" alt="logo.png" width="80px">
                                            </td>
                                            <td>{{ $kategori_artikel->name }}</td>
                                            <td class="text-center">
                                                <a href="#" onclick="hapus({{ $kategori_artikel->id }})" title="Hapus"
            ...
            function hapus(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.get('/master/kategori-artikel/delete/' + id)
