                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.partner') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.partner.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                    ...
                    <div class="card-block table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse($data as $key=> $partner)
                                        <tr>
                                            <th class="text-center">{{ $key + 1 }}</th>
                                            <td class="text-center">
                                                <img src="{{ URL($partner->img_path.$partner->img_name)}}" alt="logo.png" width="80px">
                                            </td>
                                            <td>{{ $partner->name }}</td>
                                            <td class="text-center">
                                                <a href="#" onclick="hapus({{ $partner->id }})" title="Hapus"
            ...
            function hapus(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.get('/master/partner/delete/' + id)
