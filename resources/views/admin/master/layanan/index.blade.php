                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.layanan') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.layanan.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                                    ...
                                    @forelse($data as $key=> $layanan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img src="{{ URL($layanan->img_path.$layanan->img_name)}}" alt="logo.png" width="80px">
                                            </td>
                                            <td>{{ $layanan->name }}</td>
                                            <td class="text-center">
                                                <a href="#" onclick="hapus({{ $layanan->id }})" title="Hapus"
            ...
            function hapus(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.get('/master/layanan/delete/' + id)
