                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.user') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.user.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                                    ...
                                    @forelse($data as $key=> $akun)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('master.user.edit', $akun->id) }}" title="edit"
