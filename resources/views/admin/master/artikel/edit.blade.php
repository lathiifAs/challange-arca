...
@section('konten')
    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <form action="{{ route('master.artikel.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="file"
                                            ...
                                            name="thumbnail_name" value="{{ old('thumbnail_name') }}"
                                            placeholder="thumbnail_name">
                                            <input type="hidden" name="old_thumbnail" value="{{ $data->thumbnail_name }}" id="">
                                            <input type="hidden" name="thumbnail_path" value="{{ $data->thumbnail_path }}" id="">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" required name="kategori_id">
                                            @forelse($kategori as $key=> $kt)
                                                <option value="{{ $kt->id }}" @if($data->kategori_id == $kt->id)  selected @endif>{{ $kt->name }}</option>
                                            @empty
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            name="title" value="{{ $data->title }}" required placeholder="Judul">
                                        @error('title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row col-md-12">
                                            <img src="{{ URL($data->thumbnail_path . $data->thumbnail_name) }}" alt=""
                                            width="350px">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" required name="st_publish">
                                            <option value="1" @if ($data->st_publish == '1')
                                                selected
                                            @endif>Publish</option>
                                            <option value="0" @if ($data->st_publish == '0')
                                                selected
                                            @endif>Jangan Publish</option>
                                        </select>
                                        @error('st_publish')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <label>Konten</label>
                                        <textarea name="content" class="form-control" id="summernote" cols="30" rows="30">{!! $data->content !!}</textarea>
                                        @error('content')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
