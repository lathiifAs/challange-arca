                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-3 mt-5">
                                <form action="{{ route('master.portofolio') }}" method="GET">
                            ...
                            <div class="col-md-9 mt-5 text-right">
                                <a href="{{ route('master.portofolio.add') }}" class="btn btn-primary mdi mdi mdi-magnify px-3"
                                ...
                                <tbody>
                                    @forelse($data as $key=> $porto)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('master.portofolio.edit', $porto->id) }}" title="edit"
                                                    class="btn waves-effect waves-light btn-out btn-warning rounded"><i
                                                        class="fa fa-edit"></i></a>
                                                <a href="#" onclick="hapus({{ $porto->id }})" title="Hapus"
            ...
            function hapus(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.get('/master/portofolio/delete/' + id)
