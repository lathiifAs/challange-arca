...
@section('konten')
    ...
    <div class="pcoded-inner-content">
        <div class="main-body">
            <form action="{{ route('admin.home.add') }}" method="POST" >
                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control @error('pembayaran') is-invalid @enderror" required id="pembayaran"
                                            name="pembayaran" value="{{ old('pembayaran') }}" placeholder="Rp.">
                                        <input type="hidden" class="form-control" pembayaran="role" value="siswa">
                                        @error('pembayaran')
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tr id="1">
                                                    ...
                                                    <td class="d-flex justify-content-center">
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <input type="number" class="form-control allinput present" name="presentase[]">
                                                            </div>
