                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" required
                                                    name="type">
                                                        <option @if($akun->type=='admin') selected @endif value="1">Admin</option>
                                                        <option @if($akun->type=='operator') selected @endif value="0">Operator</option>
                                        </select>
                                        @error('nama')
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row col-md-12">
                                            <label>Password &nbsp;</label> <sup style="color: orangered" class="mt-2">*<span class=""><i style="color: orangered">(Tidak perlu di isi jika tidak ingin dirubah)</sup>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-10">
